...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Tree App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Tree App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Tree App Login', user : req.user }); 
}); 
